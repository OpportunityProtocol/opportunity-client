...
export interface ITestUniswapV2FactoryInterface extends utils.Interface {
  functions: {
...
export interface ITestUniswapV2Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITestUniswapV2FactoryInterface;
