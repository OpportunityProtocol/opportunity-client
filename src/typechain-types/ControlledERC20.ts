...
export interface ControlledERC20Interface extends utils.Interface {
  functions: {
...
export interface ControlledERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ControlledERC20Interface;
