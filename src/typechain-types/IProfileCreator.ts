...
export interface IProfileCreatorInterface extends utils.Interface {
  functions: {
...
export interface IProfileCreator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IProfileCreatorInterface;
