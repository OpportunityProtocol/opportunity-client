...
export interface ITestUniswapV2PairInterface extends utils.Interface {
  functions: {
...
export interface ITestUniswapV2Pair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITestUniswapV2PairInterface;
