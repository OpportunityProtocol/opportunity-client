...
export interface TestUniswapV2Router02Interface extends utils.Interface {
  functions: {
...
export interface TestUniswapV2Router02 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestUniswapV2Router02Interface;
