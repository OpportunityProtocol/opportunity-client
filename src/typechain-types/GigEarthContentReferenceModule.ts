...
export interface GigEarthContentReferenceModuleInterface
...
export interface GigEarthContentReferenceModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GigEarthContentReferenceModuleInterface;
