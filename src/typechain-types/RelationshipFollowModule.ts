...
export interface RelationshipFollowModuleInterface extends utils.Interface {
  functions: {
    ...
    "profileIdToTrust(address,address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "profileIdToTrust",
...
export interface RelationshipFollowModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RelationshipFollowModuleInterface;
