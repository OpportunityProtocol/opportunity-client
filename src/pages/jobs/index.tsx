...
const Jobs = () => {
    ...
    const [relationshipPreviewData, setRelationshipPreviewData] = useState({
        relationshipOwner: "0x0",
        relationshipAddress: "0x0",
        relationshipMarketAddress: "0x0",
        relationshipStatus: 0,
    ...
    const getRelationships = () => {
        return dummyRelationships.map(relationship => (
                <Grid item xs={12}>
                    <JobDisplay avatar='https://picsum.photos/picsum/200/300' />
                </Grid>
        ))
    }
                ...
                <Grid
                    ...
                    <Box sx={{ width: '100%' }}>
                        ...
                        spacing={3}
                            ...
                            elevation={0}
      component="form"
      sx={{ width: 600, p: 1, border: '1px solid #eee', borderRadius: 2, elevation: 0, display: 'flex', alignItems: 'center',  }}
    >
